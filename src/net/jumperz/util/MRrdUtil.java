...
/*
// --------------------------------------------------------------------------------
public static RrdDb createStandardRrdFile2( long startTime, String type, String rrdFileName, String dataSourceName )
throws IOException
{
try
	{
	RrdDef rrdDef = new RrdDef( rrdFileName, 5 );
	rrdDef.setStartTime( startTime/ 1000L  );
	rrdDef.addDatasource( dataSourceName, type.toUpperCase(), 13, 0, Double.NaN );
...
*/
// --------------------------------------------------------------------------------
public static RrdDb createStandardRrdFile( long startTime, String type, String rrdFileName, String dataSourceName, long step, long heartbeat )
throws IOException
{
try
	{
	...
	rrdDef.setStartTime( startTime/ 1000L  );
	rrdDef.addDatasource( dataSourceName, type.toUpperCase(), heartbeat, 0, Double.NaN );
	rrdDef.addArchive( "AVERAGE", 0.5, 1, 600 );
	rrdDef.addArchive( "AVERAGE", 0.5, 6, 700 );
	rrdDef.addArchive( "AVERAGE", 0.5, 24, 775 );
	rrdDef.addArchive( "AVERAGE", 0.5, 288, 797 );
